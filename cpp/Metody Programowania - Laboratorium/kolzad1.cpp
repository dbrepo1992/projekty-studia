...
class K2 {
 ...
 //Do testowania poprawności tych klas wykorzystać instrukcje zamieszczone poniżej.
int main() {
    ...
    for (int i=0; i<4; ++i){
        tab[i]+=1;          // modyfikowana składowa w2
        cout << tab[i];
    }
    cout << "*****   4   *****\n" << endl;

    tab[1]= tab[1]+ " with sugar";      // operacja dotyczy składowej K2::w1[1]
    tab[3]= "hot " + tab[3];            // operacja dotyczy składowej K2::w1[0]
